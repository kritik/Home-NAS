...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { lft: @folder.lft, name: @folder.name, parent_id: @folder.parent_id, rgt: @folder.rgt }
    end
  ...
  test "should update folder" do
    patch :update, id: @folder, folder: { lft: @folder.lft, name: @folder.name, parent_id: @folder.parent_id, rgt: @folder.rgt }
    assert_redirected_to folder_path(assigns(:folder))
  end
