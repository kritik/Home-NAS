...
class UserFilesControllerTest < ActionController::TestCase
  ...
  test "should create user_file" do
    assert_difference('UserFile.count') do
      post :create, user_file: { changes: @user_file.changes, checksum: @user_file.checksum, extension: @user_file.extension, file_name: @user_file.file_name, file_uid: @user_file.file_uid, folder_id: @user_file.folder_id, user_id: @user_file.user_id }
    end
  ...
  test "should update user_file" do
    patch :update, id: @user_file, user_file: { changes: @user_file.changes, checksum: @user_file.checksum, extension: @user_file.extension, file_name: @user_file.file_name, file_uid: @user_file.file_uid, folder_id: @user_file.folder_id, user_id: @user_file.user_id }
    assert_redirected_to user_file_path(assigns(:user_file))
  end
